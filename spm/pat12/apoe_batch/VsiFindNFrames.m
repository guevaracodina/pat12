function [index_frame] = VsiFindNFrames(fnameBase, ModeName)
...
bytes_position = ftell(fid);

index_frame = (bytes_position - file_header) / (size*BmodeNumSamples*Nlines*2 + Nlines*line_header + frame_header);
