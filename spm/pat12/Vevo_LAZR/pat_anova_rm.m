function [p, table] = pat_anova_rm(X, displayopt)
%   [p, table] = pat_anova_rm(X, displayopt)
%   Single factor, tepeated measures ANOVA.
%
%   [p, table] = pat_anova_rm(X, displayopt) performs a repeated measures ANOVA
...
%
%   p = pat_anova_rm({patients controls});
%
%
