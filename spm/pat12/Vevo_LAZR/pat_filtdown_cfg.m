...
filtdown1.val       = {PATmat redo1 PATmatCopyChoice ROI_choice IC bpf wholeImage generate_figures save_figures};    % The items that belong to this branch. All items must be filled before this branch can run or produce virtual outputs
